    ...
    //! [3] //! [4]
{
  ...
  if (!baseClass.isEmpty()) block += " : public " + baseClass;
  block += '\n';
  block += "{\n";
...
IntroPage::IntroPage(QWidget *parent) : QWizardPage(parent) {
  ...
  label = new QLabel(
      tr("This wizard will generate a skeleton C++ class "
...
ClassInfoPage::ClassInfoPage(QWidget *parent) : QWizardPage(parent) {
  ...
  setSubTitle(
      tr("Specify basic information about the class for which you "
  ...
  copyCtorCheckBox = new QCheckBox(
      tr("&Generate copy constructor and "
         "operator="));

  defaultCtorRadioButton->setChecked(true);

  connect(defaultCtorRadioButton, &QAbstractButton::toggled, copyCtorCheckBox, &QWidget::setEnabled);
...
CodeStylePage::CodeStylePage(QWidget *parent) : QWizardPage(parent) {
  ...
  commentCheckBox = new QCheckBox(
      tr("&Start generated files with a "
         //! [14]
         "comment"));
  commentCheckBox->setChecked(true);

  protectCheckBox = new QCheckBox(
      tr("&Protect header file against multiple "
         "inclusions"));
  ...
  connect(protectCheckBox, &QAbstractButton::toggled, macroNameLabel, &QWidget::setEnabled);
  connect(protectCheckBox, &QAbstractButton::toggled, macroNameLineEdit, &QWidget::setEnabled);
  connect(includeBaseCheckBox, &QAbstractButton::toggled, baseIncludeLabel, &QWidget::setEnabled);
  connect(includeBaseCheckBox, &QAbstractButton::toggled, baseIncludeLineEdit, &QWidget::setEnabled);
...
OutputFilesPage::OutputFilesPage(QWidget *parent) : QWizardPage(parent) {
  ...
  setSubTitle(
      tr("Specify where you want the wizard to put the generated "
         "skeleton code."));
...
void ConclusionPage::initializePage() {
  ...
  finishText.remove('&');
  label->setText(tr("Click %1 to generate the class skeleton.").arg(finishText));
}
