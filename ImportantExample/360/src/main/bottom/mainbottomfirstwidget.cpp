...
void MainBottomFirstWidget::initUI()
{
    ...
    QLabel *safeLabel = new QLabel(QStringLiteral("1234"));
    ...
    QLabel *cleanLabel = new QLabel(QStringLiteral("1234"));
    ...
    QLabel *youhuaLabel = new QLabel(QStringLiteral("1234"));
    ...
    QLabel *routerTitle = new QLabel(QStringLiteral("1234"));
    QFont font = routerTitle->font();
    font.setBold(true);
    font.setPixelSize(15);
    routerTitle->setFont(font);

    QLabel *routerDes = new QLabel(QStringLiteral("1234"));
    ...
    advNameList << QStringLiteral("1234") << QStringLiteral("1234") << QStringLiteral("1234") << QStringLiteral("1234") ;
    ...
    advLabel->setText(QStringLiteral("1234"));
